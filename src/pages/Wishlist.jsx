  ...
  return (
    <div className="min-h-screen bg-[#f5f0ea] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center text-[#74541e] mb-6 hover:underline"
        >
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-serif text-[#74541e]">
            Your Wishlist <Heart className="inline ml-2" size={24} fill="#C47E20" />
          </h1>
          {wishlist.length > 0 && (
            <button 
              onClick={clearWishlist}
              className="text-sm text-[#74541e] hover:underline flex items-center"
            >
        ...
        {wishlist.length === 0 ? (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#74541e] text-white rounded hover:bg-[#5a4218] transition-colors flex items-center mx-auto"
            >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-1 py-2 bg-[#74541e] text-white rounded hover:bg-[#5a4218] transition-colors flex items-center justify-center"
                    >
                      Add to Cart
                    </button>
                  </div>
